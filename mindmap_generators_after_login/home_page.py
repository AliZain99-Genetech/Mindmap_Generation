...
# -------------------------
async def home_page(
    screenshots_folder: str = r"generated_mindmaps\340bpriceguide\screenshots_After_Login\Home",
    links_file: str = r"generated_mindmaps\340bpriceguide\home_page_links_after_login.json",
    output_mm_file: str = r"generated_mindmaps\340bpriceguide\mindmaps_After_Login/home.mm",
